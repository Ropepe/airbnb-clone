...
const Modal = ({ isOpen, onClose, onSubmit, title, body, footer, actionLabel,
  disabled, secondaryAction, secondaryActionLabel }: ModalProps) => {
  ...
  return (
    <>
      ...
      overflow-x-hidden overflow-y-hidden fixed inset-0 
          ...
          ${showModal ? 'opacity-100' : 'opacity-0'}
            ...
            shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              ...
              <div className="flex flex-col gap-2 p-6">
                <div className="flex flex-row items-center g-4 w-full">
